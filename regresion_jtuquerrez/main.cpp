...
void caso_empresa_industrial(){
    ...
    caso_regresion(x, y, title, "Gastos en Publicidad(millones de pesos)", "Volumen en ventas(millones de pesos)");
}
...
void caso_produccion_trigo(){
    ...
    caso_regresion(x, y, title, "Produccion de trigo (miles de toneladas)", "Precio del kilo de harina de trigo (pesos)", "Anio", anio);
}
...
void caso_bugs_project(){
    ...
    caso_regresion(x, y, title, "Tamaño de modulo en LDC (lineas de codigo)", "Cantidad de errores detectados");
}
